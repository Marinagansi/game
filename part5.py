...
player = Warrior('player',200,200,3, 5, 20, 5)
enemy = Warrior('enemy',400,200,3, 5, 20, 0)
...
while run:
    ...
    if player.alive:
        ...
        #throw bomb
            ...
            bomb = Bomb(player.rect.centerx+(0.5 * player.rect.size[0]* player.direction), player.rect.top, player.direction)
            bomb_group.add(bomb)
            #reduce bomb
            player.bomb -= 1
            bomb_thrown = True
